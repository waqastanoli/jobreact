...
//   "mongodb+srv://planetful_dbuser:waqas86reconfirm!@cluster0-isszx.mongodb.net/jobster?retryWrites=true";
// mongoose.connect(connection_string, {
//   useCreateIndex: true,
//   useNewUrlParser: true
// });

// mongoose.connect('mongodb://localhost:27017/jobster', {
//   useCreateIndex: true,
//   useNewUrlParser: true
// });
...
import position_routes from "./routes/position_routes";
function routing() {
  app.use("/api/v1/products", productRoutes);
  app.use("/api/v1/orders", orderRoutes);
  app.use("/api/v1/users", userRoutes);
  app.use("/api/v1/topic", topicRoutes);
  app.use("/api/v1/position", position_routes);
